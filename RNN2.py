...
post_processed_df.to_csv('result.csv')
...
mae = mean_absolute_error(post_processed_df['Temperature Predictions'],post_processed_df['Temperature Actuals'])
rmse=sqrt(mean_squared_error(post_processed_df['Temperature Predictions'],post_processed_df['Temperature Actuals']))
print(f'mae - manual: {mae}')
print(f'rmse - manual: {rmse}')
mae = mean_absolute_error(post_processed_df['Pressure Predictions'],post_processed_df['Pressure Actuals'])
rmse=sqrt(mean_squared_error(post_processed_df['Pressure Predictions'],post_processed_df['Pressure Actuals']))
print(f'mae - manual: {mae}')
print(f'rmse - manual: {rmse}')
